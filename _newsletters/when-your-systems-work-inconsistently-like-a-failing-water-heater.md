...
Just like the [hidden costs of quick fixes]({{ site.baseurl }}{% link _newsletters/how-to-manage-the-hidden-cost-of-quick-fixes.md %}) and [unnecessary complexity]({{ site.baseurl }}{% link _newsletters/why-eliminate-unnecessary-complexity.md %}), the inefficiency builds up over time.
