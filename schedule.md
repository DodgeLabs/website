...
<p><strong>Is the scheduler not loading?</strong> Your browser or network might be blocking this content.</p>
...
<script type="text/javascript">
  ...
  window.setTimeout(() => {
    let footer = document.getElementById("cal-fallback-footer");
